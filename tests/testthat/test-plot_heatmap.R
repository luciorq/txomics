...
testthat::test_that("Test if plot_heatmap runs", {
  ...
  testthat::expect_equal(res$tree_row$merge,structure(c(-16L, -5L, -21L, -9L, -11L, 3L, -2L, -7L, 4L, -8L,
                                                        ...
                                                        12L, -13L, -1L, -22L, 16L, -10L, 22L, 21L, 20L, 24L, 28L), .Dim = c(29L,
                                                                                                                            2L)))
  ...
  res3 <- plot_heatmap(imported_tx, sample_table = sample_df, color_by = c("color","condition"),
                       num = -30,show_rownames = FALSE, scale = "column")

  testthat::expect_equal(res3$tree_col$order, c(1L, 3L, 2L, 4L, 5L))

  res4 <- plot_heatmap(imported_tx, sample_table = sample_df, color_by = c("color","condition"),
