...
testthat::test_that("Test if plot_pca runs",{
  ...
  plot_pca(imported_tx, sample_table = sample_df,
  ...
  testthat::expect_equal(res2$data$value,c(-0.141589618299063, -0.180204758946487, 0.402524792746824,
  ...
  testthat::expect_equal(res3$data$PC1,c(-9.08978758902333, -1.36567534552286, -8.65240409661001, 10.1086525613534,
